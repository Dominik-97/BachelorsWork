...
Co se historie svěřenský fondů týče, tak \footnote[1]{Zde bude nějaká informace}

\newpage
\printbibheading
\printbibliography[type=misc,heading=subbibliography,title={Online sources}]
\printbibliography[type=notmisc,heading=subbibliography,title={Other sources}]
