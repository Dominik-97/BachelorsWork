...
{\Large Závěrečná část - Návrhy na změny České právní úpravy}\\
...
Zajímavá je ovšem situace, která může v tomto případě nastat. Ta souvisí, se samotným stavem zakladatele svěřenského fondu. (Pokud je mrtev jedná se stále o založení svěřenského fondu \textit{inter vivos}? Já si myslím, že ano}.

Dalším zajímavým příkladem je možnost stanovit smrt zakladatele jako odkládací podmínku, protože pak by se jednalo ve své podstatě, samotnou právní skutečností, smrt zůstavitele, o obdobu založení svěřenského fondu \textit{mortis causa}, přitom však věřím, že by se na toto založení pohlíželo jako na založení svěřenského fodnu {inter vivos}.
