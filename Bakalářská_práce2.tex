...
V tomto rámci je podstatné zmínit, že se rozlišuje mezi vytvořením a vznikem svěřenského fondu, celkový proces konstituování svěřenského fondu, tedy od okamžiku samotného rozhodnutí vytvořit svěřenský fond, až k samotnému vzniku, má tedy více fází. Vytvořením se rozumí jednání zakladatele, který vyčlení část, nebo celý svůj majetek a tento majetek poté převede do jiného jmění, tedy svěřenského fondu, který je zřízen za určitým účelem. Toto jednání zahrnuje v první řadě řádná nabídka, tedy oferta, vůči jiné osobě, která by se měla stát potenciálním správcem\footfullcite{jaroslav_svejkovsky_sprava_2015}.\\
