...
\textbf{Podmínky pro plnění} jsou plně v diskreci zakladatele svěřenského fondu, spolu s vymezením účelu a určení obmyšlených jsou určující pro posouzení jednotlivých nároků za svěřenským fondem těch, kterým má být plněno. Svěřenský správce k nim musí vázat svoji povinnost vykonávat správu s péčí řádného hospodáře\footfullcite[Strana 430]{svejkovsky_jaroslav_sverenske_2018}.\\

\textbf{Trvání}\\

\textbf{Určení obmyšlených}\\
