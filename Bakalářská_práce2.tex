...
\pagenumbering{gobble}
  ...
  \vspace{15mm}
  {\Large \textbf{Svěřenský fond jako nástroj transferu majetku mezi generacemi}} \\
  \vspace{15mm}
...
\noindent V Praze dne 08.07.2020%\today\\ {\selectlanguage{czech}\today} \\ %Změněno na české datum, možná budu muset odebrat, babel package způsobuje z nějakého důvodu error
\vspace{10mm} \\
...
\textit{"Různé podoby svěřenství či trustů jsou běžně používány už více než dva tisíce let od římského fideikomisu pro správu majetku ve většině západních zemí. Jejich návrat do českého právního řádu v podobě svěřenského fondu není ničím náhodným nebo překvapivým, nýbrž je logickým důsledkem návratu naší země do civilizačního okruhu, ke kterému po staletí patřila. (...) svěřenství bylo ve svých dobových a místních podobách oblíbeným a velmi užitečným nástrojem správy majetku (...) a stejně tak bylo velmi často používáno pro udržení celistvosti a nezcizitelnosti zejména rodinného majetku při jeho předávání následujícím generacím."}\footfullcite[Strana 173]{bednarikova_barbora_sverenske_2014}\\

Bednaříková takto shrnula historickou hodnotu svěřenství a trustů a vyslovila jejich užitečnost. Je nepochybné, že tyto instituty mají v moderních společnostech důležitou roli a mnoho využití, přičemž jedno z nich je použití za účelem mezigeneračního převodu majetku. Tato myšlenka ostatně prostupuje celou prací. Otázka však zní, zda jejich implementace ve formě svěřenského fondu je k mezigeneračním převodům majetku, s ohledem na současnou právní úpravu, stejně dobře využitelná.\\
