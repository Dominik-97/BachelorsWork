...
Obsahem je tedy pojednání o možných rizicích a namítání právě této neúčinnosti v případech rušení správy a svěřenského fondu jednotlivými věřiteli majetku fondu, neboť ten může být bezpochyby dlužníkem.\\
...
Jak již bývá u svěřenského fondu zvykem, i zde lze nalézt mnoho protichůdných názorů týkajících se procesu vypořádání závazků při zániku svěřenského fondu. Jak již bylo popsáno u daňové problematiky, u svěřenského fondu se při zániku neprovádí likvidace, ani obdobný proces, respektive zákon ji nepředpokládá, i přes to však převládá právní názor, že správce musí před vydáním majetlu dle § 1472 OZ provést vypořádání stále trvajících dluhů, které vznikly při správě svěřenského fondu\footfullcite{}.\\
