...
% --------------------------------------------------------------------------
% New defined columns, not used
% --------------------------------------------------------------------------

%\newcolumntype{b}{>{\hsize=2.5\hsize}X}
...
Problematika ve vztahu k započtení na povinný díl a k nepominutelným dědicům, za určitých okolností by tak mohlo být zakladatelské právní jednání posouzeno jako nemravné, v rozporu s veřejným pořádkem, či by mohlo být napadeno z titulu relativní neúčinnosti. Není zcela iluzorní očekávat, že se právní úprava svěřenského fondu může změnit, neboť se stále jedná o poměrně nový institut.  
