...
V tomto rámci je podstatné zmínit, že se rozlišuje mezi vytvořením a vznikem svěřenského fondu. Vytvořením se rozumí jednání zakladatele, který vyčlení část, nebo celý svůj majetek a tento majetek poté převede do jiného jmění, tedy svěřenského fondu, který je zřízen za určitým účelem. Toto jednání zahrnuje v první řadě řádná nabídka, tedy oferta, vůči jiné osobě, která by se měla stát potenciálním správcem.\\
