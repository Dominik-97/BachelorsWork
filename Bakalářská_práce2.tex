...
Závěť je odvolatelný projev vůle, má přednost před děděním ze zákona. Existuje několik typů závětí, jejich popis však není pro tuto práci důležitý. Zakladatel může v závěti též uvést podmínku\footnote{Viz vedlejší doložky v závěti, § 1551 OZ.}, minimálně co do možnosti "výplaty" nemá tolik možností jako u svěřenského fondu\footnote{Viz § 1494 OZ a dále.}.\\
...
S ohledem na úpravu mezinárodního práva soukromého v Čr však.
