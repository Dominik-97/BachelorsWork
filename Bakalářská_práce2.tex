...
Zajímavé je tak dovození, že svěřenský fond může být zřízen vyčleněním majetku smlouvou s odkládací podmínkou smrti, neboť pak by se jednalo ve své podstatě, samotnou právní skutečností, smrtí zůstavitele, o obdobu založení svěřenského fondu \textit{mortis causa}, přitom však věřím, že by se na toto založení pohlíželo jako na založení svěřenského fondu \textit{inter vivos}.\\ 
...
\textit{"darovací smlouva posuzuje jako darování pro případ smrti, na základě kterého nabývá obdarovaný vlastnické právo k předmětu daru už smrtí dárce (v případě nemovitosti má po smrti dárce právo podat návrh na vklad do katastru nemovitostí). V případě daru má obdarovaný nikoli obligační právo vůči dědicům, ale věcné právo. Nejsou-li splněny tyto náležitosti, posuzuje se smlouva jako stanovení odkazu, kterým se zřizuje obligační právo vůči dědicům."}\footnote{Tamtéž, strana 113.}\\
