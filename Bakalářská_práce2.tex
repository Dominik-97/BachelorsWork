...
\newpage
	...
	\begin{center}
		...
		\textbf{\Large Summary}\\
			\vspace*{5mm}
			The work is focused on the issue of trust funds. It deals with the historical context leading to the social need to create institutes similar to a trust fund and the subsequent development of these institutes culminating in the adoption of the Quebec fiducia legislation into the Czech legal system in the form of a trust fund. The work also emphasizes the definition of this institute, its legal codification and characteristics in relation to its use for intergenerational transfer of property. The work is divided into three parts. The first part contains a theoretical introduction to the issue and history. The second part contains a description of the legal codification of the trust fund and outlines a rather illustrative list of the benefits of the trust fund for use in the intergenerational transfer of assets. The last chapters are devoted to the problems associated with the trust fund, while the research part contains comparative research focusing mainly on the issue of conflict between the legal regulation of the trust fund and the legal regulation of inheritance together with the new concept of non-subject ownership.\\
			\vspace*{5mm}
			The aim of the bachelor thesis was to find out whether the trust fund is usable for intergenerational transfers of property together with answering the question whether the indispensable heir is protected from the possibility of circumventing his right to a mandatory share using a trust fund.\\
			\vspace*{5mm}
			The research clearly shows that the trust fund contributes to the extension of the individual sphere of ownership freedom and is thus very well applicable to intergenerational transfers of assets. However, in relation to the question of the protection of the indispensable heir, the research did not provide a clear answer as to whether or not the right of the indispensable heir is protected.\\
		\vspace*{10mm}
