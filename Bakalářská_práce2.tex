...
Ať již se budeme bavit o jakémkoliv způsobu založení svěřenského fondu, tak zákon klade na zakladatele v paragrafech (DOPLNIT) následující čtyři povinnosti:
...
Tyto mezigenerační převody majetku spočívají nejčastěji v situacích, kdy takovéto nakládání s majetkem je činěno ve vztahu k mladší generaci v jedné rodině, tedy nejčastěji k potomkům a prapotomkům. %Lingvistický výklad slova mezigenerační v sobě nicméně nezahrnuje pouze pokrevně či právně zpřízněny generace, ale i různé demografické ročníky. Je tak klidně možné tento převod učinit 
