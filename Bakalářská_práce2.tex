...
Pokud by pověření ke správě svěřenský správce nepřijal, tak by svěřenský fond vůbec nevznikl a majetek by připadl do pozůstalostního řízení, toto tedy představuje velkou nevýhodu založení svěřenského fondu tímto způsobem oproti zřízení \textit{mortis causa}, kde svěřenský fond vznikne i v případě, že svěřenský správce pověření ke správě nepřijme.\\
