...
Pro historické pochopení vzniku svěřenských institutů ve starověkém Říme je nejprve třeba přiblížit způsob fungování dědického práva v Římě, vycházejícího z principu univerzální sukcese\footnote{Do dědictví spadá jmění, tedy jak majetek, tak i závazky}\footfullcite{blaho_peter_haramia_ivan_a_zidlicka_michaela_zaklady_1997}. Po smrti zůstavitele šlo dědit
